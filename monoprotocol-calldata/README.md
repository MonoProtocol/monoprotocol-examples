# MonoProtocol Calldata Example

This example demonstrates how to perform ERC20 token transfers using MonoProtocol's smart account infrastructure. It shows the complete flow from key generation to transaction execution and monitoring.
...
- ✅ **ERC20 Token Transfers** - Execute transfers using MonoProtocol infrastructure
